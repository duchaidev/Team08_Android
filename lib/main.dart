...
import 'package:todolist/modal/Item.dart';
import 'package:todolist/width/ItemBody.dart';
import 'package:todolist/width/ModalBottom.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  void _handleEditTask(var item) {
    items.removeWhere((items) => items.id == item.id);
